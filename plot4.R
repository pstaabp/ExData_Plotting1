...
### plot 1
plot(data$timediff,data$Global_active_power,type='l',ylab="Global Active Power",xaxt="n",xlab="")
axis(1,0:2,c("Thu","Fri","Sat"))

### plot 2

plot(data$timediff,data$Voltage,type='l',ylab="Voltage",xaxt="n",xlab="")
axis(1,0:2,c("Thu","Fri","Sat"))
title(sub="datetime")
...
### plot 4
plot(data$timediff,data$Global_reactive_power,type='l',ylab="Global Reactive Power",xaxt="n",xlab="")
axis(1,0:2,c("Thu","Fri","Sat"))
title(sub="datetime")
